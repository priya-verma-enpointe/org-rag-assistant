...
# UPDATE 1: Correct import source for Pydantic Schema 'ChatHistoryResponse'
...
# UPDATE 2: Added New Endpoint to Fetch Previous Questions & Answers
...
async def get_chat_history(
    ...
    """
    Fetch all previous chat questions and answers for a specific organization.
    """
    stmt = (
        select(ChatHistory)
        .where(ChatHistory.organization_id == organization_id)
